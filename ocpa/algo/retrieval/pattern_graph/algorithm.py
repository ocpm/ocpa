from ocpa.objects.graph.pattern_graph.obj import PatternGraph, ActivityNode, ObjectTypeNode, FormulaNode, ControlFlowEdge, ObjectRelationEdge, PerformanceEdge


def apply(pattern_graph_elements):
    pg = PatternGraph(pattern_graph_elements['name'])
