# Import the built-in unittest module to create and manage test cases
import unittest
...
# Define a test case class, which inherits from unittest.TestCase, to manage and run tests for event log management.
class EventLogManagementTests(unittest.TestCase):
    ...
    def test_process_execution_extraction(self):
        ...
        self.assertEqual(len(ocel.process_executions), 80)
    ...
    def test_process_execution_extraction__by_leading_type(self):
        ...
        parameters = {"execution_extraction": "leading_type",
                      ...
                      "exact_variant_calculation": True}
        ocel = ocel_import_factory.apply(filename,parameters=parameters)
        self.assertEqual(len(ocel.process_executions), 127)
        ...
        parameters = {"execution_extraction": "leading_type",
                      ...
                      "exact_variant_calculation": True}
        ocel = ocel_import_factory.apply(filename, parameters=parameters)
        self.assertEqual(len(ocel.process_executions), 414)
